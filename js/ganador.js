...
function cambiarPantalla(){
    if(usuario.ganador == usuario.jugador1.nombre){
    ...
    }else if(usuario.ganador == usuario.jugador2.nombre){
    ...
    }else if(usuario.ganador == usuario.bot.jugador){
        ...
        empatar.innerHTML = usuario.ganador;
    }
}
